...
esp_err_t init_p2p() {
  ...
  ESP_RETURN_ON_ERROR(esp_now_init(), "init_p2p", "esp_now_init failed");
  ESP_RETURN_ON_ERROR(esp_now_register_send_cb(on_data_tx), "init_p2p", "esp_now_register_send_cb failed");
  ESP_RETURN_ON_ERROR(esp_now_register_recv_cb(on_data_rx), "init_p2p", "esp_now_register_recv_cb failed");
  ...
  ESP_RETURN_ON_ERROR(esp_now_add_peer(&broadcast_peer), "init_p2p", "esp_now_add_peer failed");
  return ESP_OK;
